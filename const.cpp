...
struct spi {
    ...
    for (const auto c : s) {
        ...
        std::string p =
          num == 0 ? "M 6.5 0.5 L 3.5 1.5 L 1.5 4.5 L 0.5 9.5 L 0.5 12.5 L 1.5 17.5 L 3.5 20.5 L 6.5 21.5 L 8.5 21.5 L 11.5 20.5 L 13.5 17.5 L 14.5 12.5 L 14.5 9.5 L 13.5 4.5 L 11.5 1.5 L 8.5 0.5 L 7 0.5"
        ...
        : num == 8 ? "M 5.5 0.5 L 2.5 1.5 L 1.5 3.5 L 1.5 5.5 L 2.5 7.5 L 4.5 8.5 L 8.5 9.5 L 11.5 10.5 L 13.5 12.5 L 14.5 14.5 L 14.5 17.5 L 13.5 19.5 L 12.5 20.5 L 9.5 21.5 L 5.5 21.5 L 2.5 20.5 L 1.5 19.5 L 0.5 17.5 L 0.5 14.5 L 1.5 12.5 L 3.5 10.5 L 6.5 9.5 L 10.5 8.5 L 12.5 7.5 L 13.5 5.5 L 13.5 3.5 L 12.5 1.5 L 9.5 0.5 L 5 0.5"
